                    ...
                    <table id="datatableid" class="table table-bordered table-dark mt-2">
                        <thead>
                            <tr>
                                ...
                                <th scope="col"> UPLOAD THE RELAVANT DOCUMENT </th>
                        ...
                        $table_query = "SELECT * FROM researchconsultancies ORDER BY id ASC";
                        ...
                        <tbody> <!-- change -->
                            ...
                            <a href="../../ecell/researchconsultancies/uploadsindex2/<?php echo $developer['pdffile1']; ?>"  class="download" title="Download" data-toggle="tooltip"><i class="fa fa-download"></i></a>
                ...
                <h4> Search Data </h4>
                    ...
                    <thead>
                        <tr>
                            ...
                            <th> UPLOAD THE RELAVANT DOCUMENT </th>
                        </tr>
                    <thead>       
<?php 
        ...
        $queryresult = mysqli_num_rows($result); ?>
                ...
                while($row = mysqli_fetch_assoc($result)){   
                    ...
                    <tr>                
                        ...
                        <td> <?php echo $row['Type_Govt_Non-Govt']; ?> </td>
